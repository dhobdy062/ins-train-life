...
const TRAINER_FAQ: HelpItem[] = [
  ...
  {
    question: "How should I use 30/60/90 goals?",
    answer:
      "Set one measurable team target per horizon. Keep targets specific (for example, team level distribution and completion percentages) and review weekly.",
  },
];
...
const GOAL_TEMPLATES: GuideItem[] = [
  {
    title: "30-Day Goal",
    steps: [
      "Set a level-distribution target (example: 50% of team at Level 3).",
      "Set a coaching cadence for weekly review.",
      "Track score trend and hard-stop rate by trainee.",
    ],
  },
  {
    title: "60-Day Goal",
    steps: [
      "Set a team-level readiness target (example: all trainees at Level 3).",
      "Set a completion target (example: 5%-20% complete all levels).",
      "Adjust coaching plans using objection-level performance trends.",
    ],
  },
  {
    title: "90-Day Goal",
    steps: [
      "Set full deployment readiness targets by team segment.",
      "Track consistency, not just peak scores.",
      "Finalize next-quarter training priorities from gap analysis.",
    ],
  },
];
  ...
  return (
    <>
      <section className="glass panel">
        ...
        <h3>FAQ, playbooks, and coaching documentation</h3>
        <p className="disclaimer">Use this page as the internal guide for trainers and trainees.</p>
      </section>
      ...
      <section className="glass panel">
        <div className="tag">Planning</div>
        <h3>30/60/90 team goal templates</h3>
        <div className="split">
